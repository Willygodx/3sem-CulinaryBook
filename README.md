...
## Использование
- **MacOS**: можно просто запустить CulinaryBook.app (находится в директории **build-MacOS/CulinaryBook.app/Contents/MacOS**).
- **Other OS**: необходимо пересобрать проект. Удалите папку build-MacOS, пересоберите проект и запускайте.