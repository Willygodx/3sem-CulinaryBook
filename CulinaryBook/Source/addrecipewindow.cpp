    ...
    : QDialog(parent)
{
    ...
    kitchenComboBox->addItem("Итальянская кухня");
    kitchenComboBox->addItem("Индийская кухня");
    kitchenComboBox->addItem("Грузинская кухня");
    kitchenComboBox->addItem("Японская кухня");
    kitchenComboBox->addItem("Французская кухня");
    kitchenComboBox->addItem("Американская кухня");
    kitchenComboBox->addItem("Тайская кухня");
    kitchenComboBox->addItem("Греческая кухня");
    kitchenComboBox->addItem("Мексиканская кухня");
    kitchenComboBox->addItem("Средиземноморская кухня");
    kitchenComboBox->addItem("Восточная кухня");
